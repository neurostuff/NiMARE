...
from nimare.ml import extract_features
...
# -----------------------------------------------------------------------------
# :func:`~nimare.ml.extract_features` applies an MKDA kernel to the coordinates
# of each analysis to generate voxelwise MA features, and reads the
...
# :meth:`~nimare.ml.FeatureSet.make_preprocessor` builds the step that
