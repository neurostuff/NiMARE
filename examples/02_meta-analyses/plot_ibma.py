...
from nimare.meta.ibma import (Fishers, Stouffers, RandomEffectsGLM)
...
# ------------------------------------------
meta = RandomEffectsGLM(null='theoretical', n_iters=None)
meta.fit(dset)
plot_stat_map(meta.results.get_map('z'), cut_coords=[0, 0, -8],
              draw_cross=False, cmap='RdBu_r')
...
# ------------------------------------------
meta = RandomEffectsGLM(null='empirical', n_iters=100)
meta.fit(dset)
plot_stat_map(meta.results.get_map('z'), cut_coords=[0, 0, -8],
              draw_cross=False, cmap='RdBu_r')
