...
# CoordinateGenerator uses z or p statistical maps
...
# * 'replace' will create coordinates for studies contrasts with images.
...
# * 'demolish' will create coordinates for studies contrasts with images
...
coord_fill = CoordinateGenerator(merge_strategy="fill")
coord_replace = CoordinateGenerator(merge_strategy="replace")
coord_demolish = CoordinateGenerator(merge_strategy="demolish")
...
# The difference is becuase in 'fill' most of the original coordinates
...
coord_two_sided = CoordinateGenerator(merge_strategy="demolish", two_sided=True)
