...
# We convert the transformed collections to Studysets before fitting the ALE
# estimator.

ale = ALE()
res_fill = ale.fit(Studyset.from_dataset(dset_fill))
res_replace = ale.fit(Studyset.from_dataset(dset_replace))
res_demolish = ale.fit(Studyset.from_dataset(dset_demolish))
...
# plot the results
ale = ALE()
res_positive = ale.fit(Studyset.from_dataset(dset_positive))
res_negative = ale.fit(Studyset.from_dataset(dset_negative))
