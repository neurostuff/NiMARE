...
class Diagnostics(NiMAREBase):
    ...
    def transform(self, result):
        ...
        contribution_table : :obj:`pandas.DataFrame`
            ...
            If no clusters are found or a pairwise Estimator was used, this table will be empty.
        ...
        """
        empty_contribution_table = False
        if not hasattr(result.estimator, "dataset"):
            LGR.warn(
                ...
                "The ``contribution_table`` will be returned as an empty DataFrame."
            )
            empty_contribution_table = True
