...
def _get_parser():
    ...
    ale_parser = subparsers.add_parser(
        'ale',
        help=('Run an activation likelihood estimation (ALE) meta-analysis on '
    ...
    ale_parser.add_argument(
        ...
        dest='prefix',
        type=str,
        help=('Common prefix for output maps.'),
        default=''
    )
    ale_parser.add_argument(
        '--file2',
    ...
    conperm_parser.add_argument(
        ...
        metavar='FILE',
        type=lambda x: _is_valid_file(parser, x),
        help=('Data to analyze. May be a single 4D file or a list of 3D '
              'files.'),
    )
    conperm_parser.add_argument(
        '--output_dir',
    ...
    macm_parser = subparsers.add_parser(
        'macm',
        help=('Run a meta-analytic coactivation modeling (MACM) '
    ...
    scale_parser = subparsers.add_parser(
        'scale',
        help=('Method for performing Specific CoActivation Likelihood '
    ...
    cluster_parser = subparsers.add_parser(
        'metacluster',
        help=('Method for investigating recurrent patterns of activation '
    ...
    cluster_parser.add_argument(
        ...
        type=int,
        nargs=2,
        help=('Select a range for k over which clustering solutions will be '
    ...
    sleuth2nimare_parser = subparsers.add_parser(
        'sleuth2nimare',
        help=('Convert a Sleuth text file to a NiMARE json file.')
    )
    ...
    neurosynth2nimare_parser = subparsers.add_parser(
        'neurosynth2nimare',
        help=('Convert a Neurosynth text file to a NiMARE json file.')
    )
