...
class CBMREstimator(Estimator):
    ...
    **kwargs
    ...
    def _model_structure(self, model, penalty, device):
        ...
        For stochastic models, there're three options: Poisson, NB, clustered NB models.
        For penalty term, we only consider Firth-type penalty currently.

        Parameters
        ----------
        model : :obj:`str`
            Name of stochastic model in CBMR: Poisson, NB or clustered NB models.
        penalty : :obj:`bool`
