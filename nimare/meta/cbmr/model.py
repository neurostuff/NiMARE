...
_CLOSED_FORM_WARNING = (
    ...
    "and hypothesis tests -- from closed-form formulas  to replace automatic differentiation of the "
    "log-likelihood. The closed form formulas were derived and implemented with the help of a large "
    "language model. They are checked against symbolic proofs and against automatic "
