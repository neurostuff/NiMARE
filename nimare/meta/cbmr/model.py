...
_CLOSED_FORM_WARNING = (
    ...
    "https://github.com/neurostuff/NiMARE/pull/1121 to replace automatic differentiation of the "
    "log-likelihood. Those formulas were derived and implemented with the help of a large "
