    ...
    **kwargs
    ...
    def correct_fwe_montecarlo(
        ...
        images : :obj:`dict`
            ...
            - logp: Uncorrected ``-log10(p)`` map.
            - logp_desc-size_level-cluster: Cluster-level FWE-corrected ``-log10(p)`` map based on
              cluster size.
            - logp_desc-mass_level-cluster: Cluster-level FWE-corrected ``-log10(p)`` map based on
              cluster mass.
