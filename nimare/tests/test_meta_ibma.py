...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ibma.Fishers, {}, FDRCorrector, {"method": "indep", "alpha": 0.001}, id="Fishers",
        ),
        pytest.param(ibma.Stouffers, {"use_sample_size": False}, None, {}, id="Stouffers",),
        pytest.param(
            ibma.Stouffers, {"use_sample_size": True}, None, {}, id="Stouffers_weighted",
        ),
        pytest.param(ibma.WeightedLeastSquares, {"tau2": 0}, None, {}, id="WeightedLeastSquares",),
        pytest.param(ibma.DerSimonianLaird, {}, None, {}, id="DerSimonianLaird",),
        pytest.param(ibma.Hedges, {}, None, {}, id="Hedges",),
        pytest.param(
