...
NiMARE requires Python ``>=3.10`` and a number of packages.
For a complete list, please see ``nimare/setup.cfg``.

.. note::
    We only support Python versions that are part of the Python release cycle (i.e., 3.10, 
    3.11, 3.12, 3.13, and 3.14). For more information, see `Python Supported Versions`_.
